...
// public static Error400Response of(final ErrorCode code, final BindingResult
// bindingResult) {
...
// private FieldError(final String field, final String objName, final String
...
// "Your request value is " + error.getRejectedValue() + " for " +
// error.getField() + " of "
// + error.getObjectName() + ". You can check the request value and try
// again."))
