...
// public static Error405Response of(final ErrorCode code, final
...
// private FieldError(final String message, final String requestedMethod, final
...
// private static Map<String, String> of(final
// HttpRequestMethodNotSupportedException e) {
...
// put("possibleSolution", "you use " + e.getMethod() + " method, but you can
// use "
// + Arrays.toString(e.getSupportedMethods())
// + " method(s) for this request. Please check the request method and try
// again.");
// }
// };
// }
