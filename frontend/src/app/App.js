  ...
  return (
    ...
    <Router>
      <Routes>
        ...
        <Route exact path="/errortype/MethodArgumentNotValid" element={ <MethodArgumentNotValid/> } /> 
        <Route exact path="/errortype/TypeMismatch" element={ <TypeMismatch/> } /> 
        <Route exact path="/errortype/NoHandlerFound" element={ <NoHandlerFound/> } /> 
        <Route exact path="/errortype/HttpRequestMethodNotSupported" element={ <HttpRequestMethodNotSupported/> } /> 
        <Route exact path="/errortype/HttpMediaTypeNotSupported" element={ <HttpMediaTypeNotSupported/> } /> 
        <Route exact path="/errortype/NullPointer" element={ <NullPointer/> } /> 
        <Route exact path="/errortype/Arithmetic" element={ <Arithmetic/> } /> 
        <Route exact path="/errortype/ArrayIndexOutOfBounds" element={ <ArrayIndexOutOfBounds/> } /> 
        <Route exact path="/errortype/IndexOutOfBounds" element={ <IndexOutOfBounds/> } /> 
        <Route exact path="/errortype/IllegalArgument" element={ <IllegalArgument/> } /> 
      </Routes>
    </Router>
  );
}
